...
import { Currency, Locale } from './Locales'
import { Currencies } from 'ts-money'
import { Artist } from './Artist'

export const DummyCurrencies = [
    new Currency(Currencies.USD.symbol, Currencies.USD.code, "미국 달러"),
    new Currency(Currencies.KRW.symbol, Currencies.KRW.code, "대한민국 원"),
    new Currency(Currencies.JPY.symbol, Currencies.JPY.code, "일본 엔화")
]

export const DummyLocales = [
    new Locale(1, 'en', 'US'),
    new Locale(2, 'ko', 'KR'),
    new Locale(3, 'ja', 'JP'),
]
